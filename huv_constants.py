...
# ─────────────────────── PATRONES REGEX DEFINITIVOS (VERSIÓN PERFECCIONADA) ───────────────────────
PATTERNS_HUV = {
    # NOTA: El patrón de nombre_completo se maneja con función especial extract_multiline_name_perfect()
    # para casos donde los nombres están divididos en múltiples líneas
    'nombre_completo': r'Nombre\s*:\s*(.*?)N\.Identificación',  # Patrón base - se usa función especial
...
MALIGNIDAD_KEYWORDS = [
    ...
    # Términos expandidos para mejor detección
    'NEOPLASIA ONCOCITICA', 'CARCINOMA NEUROENDOCRINO', 'TUMOR PRIMARIO',
    'CARCINOMA ESCAMOCELULAR', 'CARCINOMA UROTELIAL', 'CARCINOMA BASOCELULAR',
    'ADENOCARCINOMA METASTASICO', 'ADENOCARCINOMA INVASIVO', 'ADENOCARCINOMA PRIMARIO',
    'ADENOCARCINOMA DUCTAL', 'NEOPLASIA RENAL', 'NEOPLASIA PAPILAR',
    'NEOPLASIA ENDOCRINA', 'TUMOR SOLIDO', 'TUMOR EPITELIAL',
    'LESION MALIGNA', 'LESION ONCOLOGICA', 'PROCESO NEOPLASICO',
    'INFILTRANTE', 'INVASIVO'
]

# ─────────────────────── PALABRAS CLAVE ESPECÍFICAS PARA IHQ ───────────────────────
MALIGNIDAD_KEYWORDS_IHQ = [
    'CARCINOMA', 'CANCER', 'MALIGNO', 'MALIGNIDAD', 'METASTASIS', 'METASTÁSICO',
    'NEOPLASIA MALIGNA', 'TUMOR MALIGNO', 'ADENOCARCINOMA', 'LINFOMA',
    'SARCOMA', 'MELANOMA', 'LEUCEMIA', 'HODGKIN', 'HODKING',
    # Términos específicos para IHQ
    'NEOPLASIA ONCOCITICA', 'CARCINOMA NEUROENDOCRINO', 'TUMOR PRIMARIO',
    'CARCINOMA ESCAMOCELULAR', 'CARCINOMA UROTELIAL', 'CARCINOMA BASOCELULAR',
    'ADENOCARCINOMA METASTASICO', 'ADENOCARCINOMA INVASIVO', 'ADENOCARCINOMA PRIMARIO',
    'ADENOCARCINOMA DUCTAL', 'NEOPLASIA RENAL', 'NEOPLASIA PAPILAR',
